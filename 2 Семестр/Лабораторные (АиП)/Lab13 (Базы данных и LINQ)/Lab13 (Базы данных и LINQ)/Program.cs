...
class App
{
    ...
    static void QueryExecution()
    {
        while (true)
        {
            ...
            {
                case 1:
                    TopSuppliersByTotalAmount();
                    break;
                case 2:
                    DeliveriesGroupedByDate();
                    break;
                case 3:
                    ProductsGroupedBySupplier();
                    break;
                case 4:
                    MostFrequentlyDeliveredProduct();
                    break;
                case 5:
    ...
    static void TopSuppliersByTotalAmount()
    {
    ...
    static void DeliveriesGroupedByDate()
    {
    ...
    static void ProductsGroupedBySupplier()
    {
    ...
    static void MostFrequentlyDeliveredProduct()
    {
